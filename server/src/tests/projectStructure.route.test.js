...
const controller = {
  ...
  detectCypressConfig: (_req, res) => res.status(200).json({ success: true }),
  detectMissingTestFramework: (_req, res) => res.status(200).json({ success: true, data: {} }),
  runPlaywrightTests: (_req, res) => res.status(200).json({ success: true }),
  runCypressTests: (_req, res) => res.status(200).json({ success: true }),
  runCypressSystemTests: (_req, res) => res.status(200).json({ success: true }),
  runCypressCoverage: (_req, res) => res.status(200).json({ success: true }),
  ...
  runVitestCoverage: (_req, res) => res.status(200).json({ success: true }),
