...
export const processAiSuggestJob = async (jobId) => {
    try {
        ...
        const finalPrompt = buildFinalPrompt(payload, { mode: "FULL", hasJest });
        ...
        await addJobLog(jobId, "INFO", "Saving suggestions and tests to database...");
        
        // Remove existing suggestions and tests for this snapshot to prevent duplicates
        ...
        if (tests.length > 0) {
            ...
            await addJobLog(jobId, "INFO", `Saved ${tests.length} test files.`);
        } else {
            await addJobLog(jobId, "INFO", "No test files were generated by the AI.");
        }
